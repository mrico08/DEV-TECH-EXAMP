    ...
    <div class="card-body pt-2 row">
        <div class="table-responsive">
            <table class="table align-items-center mb-0">
                ...
                <tbody>
                    <?php
                        $qry = mysqli_query($conn,"SELECT * FROM persons");
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <div class="d-flex justify-content-center">
                                        ...
                                        class="btn bg-gradient-info me-2 edit_button">Update</button>
                                        <button type="button" id="<?php echo $row['id'];?>" class="btn bg-gradient-danger delete_button">Delete</button>
                                    </div>
                                </td>
                            </tr>
                            <?php
...
<?php include("page/modal/update_record.php")?>